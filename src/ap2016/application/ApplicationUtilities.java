...
public class ApplicationUtilities {
	...
	{
		// This method practically does the inverse of Arrays.toString(array). However, this method does not works with Strings representing arrays of arrays, because it is not required by this application.
		if (str.equals("[]"))
			return new byte[0];
