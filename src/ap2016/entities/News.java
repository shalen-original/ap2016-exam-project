...
public class News {
	 ...
	 */
	/*
	 * This field is not a "Date". Using the "Date" type has proven to create serious issues when parsing from a new "import" file. Moreover, dates can be represented in many ways as a String and Date only offers deprecated methods to parse String. 
	 */
